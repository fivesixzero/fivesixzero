...
- ⚙️ Open source 3D model and PCB design
  ...
  - Various "functional" prints, posted on my Printables profile: [`fivesixzero`](https://www.printables.com/@fivesixzero)
...
- 🛠 Microcontroller development with Arduino and CircuitPython
- 🍇 Raspberry Pi hacking and development
- 👾 EVE Online and Eve Frontier 3rd party app development
- 🧙🏼‍♂️ IoT device hacking

## Are you a recruiter?

If so, I am _**`currently open to new opportunities`** with a start date **`no earlier than October 1st, 2026`**_.
